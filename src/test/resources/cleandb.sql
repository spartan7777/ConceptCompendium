...
insert into concept values (1, 1, 'Jedi', 'Abstracts', 9, 'An ancient religion whose followers defend the galaxy and are beleived to have legendary powers.'),
                           ...
                           (10, 4, 'Bowcaster', 'Weapons', 4, 'A bowcaster is also known as a laser crossbow. Is a handcrafted projectile weapon commonly used by Wookiees.'),
                           (11, 4, 'Kashyyyk', 'Environments', 3, 'Kashyyyk is a tree-covered forest planet and the homeworld of the Wookiee species.'),
                           (12, 5, 'Tatooine', 'Environments', 3, 'Tatooine is a desert world in the Outer Rim that is inhabited by poor locals who mostly farm moisture for a living.'),
                           (13, 5, 'Star Destroyer', 'Vehicles', 7, 'A medium-sized capital ship used by the Galactic Empire. A heavily armed warship.'),
                           ...
                           (16, 7, 'Hyperdrive', 'Accessories', 5, 'A propulsion system that allows a starship to reach lightspeed and travel in the alternate dimension of hyperspace.');