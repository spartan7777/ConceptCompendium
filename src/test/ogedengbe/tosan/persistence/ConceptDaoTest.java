...
class ConceptDaoTest {
    ...
    void insertConceptSuccess() {
        Concept newConcept = new Concept(10, 4, "Bowcaster", "Weapons", 4, "A bowcaster is also known as a laser crossbow. Is a handcrafted projectile weapon commonly used by Wookiees.");
